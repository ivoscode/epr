...
var _Field2 = _interopRequireDefault(
  require("formiojs/components/_classes/field/Field")
);
    ...
    [
      ...
      },
      {
        ...
        get: function get() {
          return (
            this.showDay &&
            _lodash.default.get(this.component, "fields.day.required", false)
          );
        },
      },
      {
      ...
      },
      {
        ...
        get: function get() {
          return (
            this.showMonth &&
            _lodash.default.get(this.component, "fields.month.required", false)
          );
        },
      },
      {
      ...
      },
      {
        ...
        get: function get() {
          return (
            this.showYear &&
            _lodash.default.get(this.component, "fields.year.required", false)
          );
        },
      },
      {
      ...
      },
      {
        ...
        get: function get() {
          return (
            _get(
              _getPrototypeOf(DayComponent.prototype),
              "shouldDisabled",
              this
            ) || this.parentDisabled
          );
          ...
          return {
            ...
            attr: {
              ...
              class: "form-control ".concat(
                this.transform("class", "formio-day-component-".concat(name))
              ),
              type:
                this.component.fields[name].type === "select"
                  ? "select"
                  : "number",
      ...
      },
      {
        ...
        get: function get() {
          ...
          this._days = [
            {
              value: "",
              label: _lodash.default.get(
                this.component,
                "fields.day.placeholder",
                ""
              ),
            },
          ];
          ...
          this._years = [
            {
              ...
              label: _lodash.default.get(
                this.component,
                "fields.year.placeholder",
                ""
              ),
            },
          ];
          var minYears =
            _lodash.default.get(this.component, "fields.year.minYear", 1900) ||
            1900;
          var maxYears =
            _lodash.default.get(this.component, "fields.year.maxYear", 2030) ||
            2030;
      ...
      },
      {
        ...
        value: function setErrorClasses(elements, dirty, hasError) {
          _get(
            ...
            "setErrorClasses",
            this
          ).call(this, elements, dirty, hasError);
      ...
      },
      {
        ...
        value: function removeInputError(elements) {
          _get(
            ...
            "removeInputError",
            this
          ).call(this, [this.refs.day, this.refs.month, this.refs.year]);
      ...
      },
      {
        key: "init",
        value: function init() {
          _get(_getPrototypeOf(DayComponent.prototype), "init", this).call(
            this
          );
          ...
          var dateFormatInfo = (0, _utils.getLocaleDateFormatInfo)(
        ...
        value: function renderField(name) {
          ...
          if (this.component.fields[name].type === "select") {
            return this.renderTemplate("select", {
              ...
              selectOptions: this["".concat(name, "s")].reduce(function (
                html,
                option
              ) {
                return (
                  html +
                  _this.renderTemplate("selectOption", {
                    option: option,
                    selected: false,
                    attrs: {},
                  })
        ...
        value: function attach(element) {
          ...
          if (this.shouldDisabled) {
            ...
            this.addEventListener(this.refs.month, "input", function () {
              var maxDay = _this2.refs.year
                ? parseInt(
                    new Date(
                      _this2.refs.year.value,
                      _this2.refs.month.value,
                      0
                    ).getDate(),
                    10
                  )
      ...
      },
      {
        ...
        value: function normalizeValue(value) {
          ...
          var getNextPart = function getNextPart(shouldTake, defaultValue) {
            return dateParts.push(
              shouldTake ? valueParts.shift() : defaultValue
            );
          };
      ...
      },
      {
        ...
        value: function getFieldValue(name) {
          ...
          val = parseInt(val, 10);
          return !_lodash.default.isNaN(val) && _lodash.default.isNumber(val)
            ? val
            : 0;
        },
      },
      ...
      },
      {
        ...
        value: function getDate(value) {
          ...
          if (day === undefined || _lodash.default.isNaN(day)) {
            day =
              defaults[DAY] && !_lodash.default.isNaN(defaults[DAY])
                ? defaults[DAY]
                : 0;
          }
          ...
          if (month === undefined || _lodash.default.isNaN(month)) {
            month =
              defaults[MONTH] && !_lodash.default.isNaN(defaults[MONTH])
                ? defaults[MONTH]
                : 0;
          }
          ...
          if (year === undefined || _lodash.default.isNaN(year)) {
            year =
              defaults[YEAR] && !_lodash.default.isNaN(defaults[YEAR])
                ? defaults[YEAR]
                : 0;
          }
          ...
          if (this.component.dayFirst) {
            result = ""
              .concat(day)
              .concat(
                (this.showDay && this.showMonth) ||
                  (this.showDay && this.showYear)
                  ? "/"
                  : ""
              )
              .concat(month)
              .concat(this.showMonth && this.showYear ? "/" : "")
              .concat(year);
          } else {
            result = ""
              .concat(month)
              .concat(
                (this.showDay && this.showMonth) ||
                  (this.showMonth && this.showYear)
                  ? "/"
                  : ""
              )
              .concat(day)
              .concat(this.showDay && this.showYear ? "/" : "")
              .concat(year);
          }
      ...
      },
      {
        ...
        value: function normalizeMinMaxDates() {
          return [this.component.minDate, this.component.maxDate].map(function (
            date
          ) {
      ...
      },
      {
        key: "validationValue",
        get: function get() {
          var _ref3 = this.dayFirst
            ? this.normalizeMinMaxDates()
      ...
      },
      {
        ...
        value: function focus() {
          if (
            (this.dayFirst && this.showDay) ||
            (!this.dayFirst && !this.showMonth && this.showDay)
          ) {
            var _this$refs$day;

            (_this$refs$day = this.refs.day) === null ||
            _this$refs$day === void 0
              ? void 0
              : _this$refs$day.focus();
          } else if (
            (this.dayFirst && !this.showDay && this.showMonth) ||
            (!this.dayFirst && this.showMonth)
          ) {
            var _this$refs$month;

            (_this$refs$month = this.refs.month) === null ||
            _this$refs$month === void 0
              ? void 0
              : _this$refs$month.focus();
          } else if (!this.showDay && !this.showDay && this.showYear) {
            var _this$refs$year;

            (_this$refs$year = this.refs.year) === null ||
            _this$refs$year === void 0
              ? void 0
    ...
    [
      {
        ...
        value: function schema() {
          ...
          return _Field2.default.schema.apply(
            _Field2.default,
            [
              {
                type: "day",
